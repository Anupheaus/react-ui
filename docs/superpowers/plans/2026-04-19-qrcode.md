...
| Create | `src/components/QRCode/README.md` | Component docs |
...
| Modify | `src/components/README.md` | Add QRCode entry to Surfaces table |
...
- Create: `src/components/QRCode/README.md`
...
- [ ] **Step 4: Create `src/components/QRCode/README.md`**
...
```bash
git add src/components/QRCode/index.ts src/components/index.ts src/components/README.md src/components/QRCode/README.md
