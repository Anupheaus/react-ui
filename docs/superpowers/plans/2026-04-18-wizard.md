...
| `src/components/Wizard/AGENTS.md` | Component README |
| `src/components/index.ts` | Add `export * from './Wizard'` |
| `src/components/AGENTS.md` | Add Wizard entry to Windows & Dialogs table |
...
**Files:**
- Create: `src/components/Wizard/AGENTS.md`
...
```bash
git -C C:/code/personal/react-ui add src/components/Wizard/AGENTS.md src/components/AGENTS.md
