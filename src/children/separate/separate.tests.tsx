...
it('can seperate children into the required types', () => {
  ...
  const { component1s, component2s, component3s, others } = React.Children
    .separate(a.props.children, { component1s: Component1, component2s: Component2, component3s: Component3 });
