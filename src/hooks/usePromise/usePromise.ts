...
// type PromiseResolver = <T = void>(value: T)=> void;
// type PromiseRejecter = <T = unknown>(reason: T)=> void;

// export function usePromise() {
//   const promiseRef = useRef(new Map<string, PromiseData>()).current;

//   const create = useBound(<T = void>(timeout?: number): Promise<T> => {
