...
// export function createLegacyStyles<TStyles extends MapOf<CSSObject>, TVariants extends
// MapOf<LegacyTheme>, TProps extends AnyObject = AnyObject>(delegate: UseStylesDelegate<TStyles, TVariants, TProps>): UseStyles<TStyles, TVariants, TProps>;
// export function createLegacyStyles<TStyles extends MapOf<CSSObject>>(styles: TStyles): UseStyles<TStyles, {}>;
// // eslint-disable-next-line max-len
// export function createLegacyStyles<TStyles extends MapOf<CSSObject>, TVariants extends MapOf<LegacyTheme>,
// TProps extends AnyObject = AnyObject>(stylesOrDelegate: TStyles | UseStylesDelegate<TStyles, TVariants, TProps>): UseStyles<TStyles, TVariants, TProps> {
