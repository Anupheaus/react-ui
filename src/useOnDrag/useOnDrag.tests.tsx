...
import '../extensions';
import { IOnDragStartData, IOnDragData, IOnDragEndData, IUseOnDragConfig } from './models';
import { useOnDrag } from './useOnDrag';

describe('useDragging', () => {

  function createComponentWithDragging(config: IUseOnDragConfig, onDragStart: (data: IOnDragStartData) => any, onDrag: (data: IOnDragData) => void,
    onDragEnd: (data: IOnDragEndData) => void) {
