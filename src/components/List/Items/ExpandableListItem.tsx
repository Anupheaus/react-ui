...
// interface Props<T extends ReactListItem, R extends ReactListItem> {
//   label?: ReactNode;
//   items?: R[];
...
// export const ExpandableListItem = createComponent('ExpandableListItem', <T extends ReactListItem, R extends ReactListItem>({
//   label,
//   items,
//   getItemLabel,
//   onExpand,
...
//         <SimpleListItem actions={actions} onSelect={selected}>
