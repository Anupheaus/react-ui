...
export const Draggable = createComponent({
  id: 'Draggable',
  ...
  render({
    ...
    return (<>
      ...
      />, document.body)}
      {/*generateContent({ ...draggableProps, name: tagName, ref: interactionTarget, className: join(isDragging && onDraggingClassName) })*/}
      {/*createPortal(generateContent({
        ref: dragMovable,
        name: `${tagName}-clone`,
        className: join(css.clonedDraggable, clonedClassName, isDragging && css.isDraggingClone, isDragging && onDraggingClonedClassName),
        style,
