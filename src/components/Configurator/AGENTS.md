...
- [../../models/AGENTS.md](../../models/AGENTS.md) — `ReactListItem` is the base type for `ConfiguratorItem` and `ConfiguratorSlice`; the namespace factory methods (`from`, `is`, `render`) are used internally
