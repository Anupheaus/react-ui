...
export const CalendarMonthViewCell = createComponent({
  id: 'CalendarMonthViewCell',

  styles: ({ useTheme }) => {
    const { definition: { monthViewCellDateFontSize, monthViewCellDateFontWeight, monthViewTodayBackgroundColor } } = useTheme(CalendarTheme);
    return {
      styles: {
        cell: {
          position: 'relative',
